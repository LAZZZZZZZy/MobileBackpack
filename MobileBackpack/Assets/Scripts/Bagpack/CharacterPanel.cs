...
public class CharacterPanel : Inventory
{
    ...
    public static CharacterPanel Instance
    {
        get
        {
            if (_instance == null)
            {
                _instance = GameObject.Find("Equipment").GetComponent<CharacterPanel>();
            }
            return _instance;
        }
    }
    ...
    {
        base.Start();
        characterPropertyText = GameObject.Find("Stats/StatsViewPoint/Text").GetComponent<Text>();
    ...
    public void PutOn(Item item)
    {
        ...
        if (exitItem != null)
        {
            //Knapsack.Instance.StoreItem(exitItem);//把角色面板上是物品替换到背包里面
        }
    ...
    {
        //Knapsack.Instance.StoreItem(item);//把角色面板上是物品替换到背包里面
        //UpdatePropertyText();//更新显示角色属性值
    }
