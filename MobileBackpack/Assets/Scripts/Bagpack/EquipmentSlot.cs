...
public class EquipmentSlot : Slot
{
    ...
    public override void OnPointerClick(UnityEngine.EventSystems.PointerEventData eventData)//重写父类Slot的方法
    {
        if (InventoryManager.Instance.IsPickedItem == false && eventData.button == PointerEventData.InputButton.Right)//鼠标右键点击直接实现脱掉，不经过拖拽
        {
